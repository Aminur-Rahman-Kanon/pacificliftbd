import { ProductsPageSkeletonType } from "../types/productPageSkeleton"

export const productPageSkeleton: ProductsPageSkeletonType = {
    'low-rise-elevator': {
        'hero': {
            heroTop: {
                img: '/images/lowRiseElevator/hero.jpg',
        ...
        "text-container-2": {
            ...
            link: {
                text: 'learn more PL signature service',
                href: '#'
            }
        },
        'navigations': [
    ...
    'mid-rise-elevator': {
        'hero': {
            heroTop: {
                img: '/images/midRiseElevator/hero.jpg',
            ...
            heroBottom: {
                ...
                text: [
                    ...
                    'Our elevators can be customized to enhance the aesthetics of the building and save space, and with our innovative elevator technology, we offer comfort, reliability, and performance at all price points. Traffic flow and security are top-of-mind for buildings of all sizes. Our Otis Compass® 360 destination management software allows for dispatching and floor access rights in the configuration of your choice, so passengers don’t waste time waiting around.'
                ],
                link: {
                    text: 'contact us',
                    href: '#'
    ...
    'high-rise-elevator': {
        'hero': {
            heroTop: {
                img: '/images/highRiseElevator/hero.jpg',
            ...
            heroBottom: {
                ...
                text: [
                    ...
                    'No matter what configuration you need in your space, we have you covered. Whether your building holds luxury housing, high-end hotel rooms, or busy office spaces, we know aesthetics are an important part of every passenger’s journey. Our elevators can be customized to enhance the design of your space without losing the practicality needed to keep people moving.'
                ],
                link: {
                    text: 'contact us',
                    href: '#'
